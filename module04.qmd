...
will return a table that, while not perfect, is already a lot easier to incorporate into reporting than the standard R outputs (see below).

![Example default output from flextable](pics/module04_flextable_example.jpeg){fig-alt="An image of a table containing passenger ID and case status"}
