...
You may choose to do differently for your analysis, but for our walkthrough of this module, we'll use the following guidelines to recode these values into something we can use: 
