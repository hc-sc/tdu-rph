...
3. Access to this website, or an offline version of the case study materials
...
In order to complete the case study, you'll need to download the datasets available on the course Github repository. While you can download the entire course as a .zip file and extract the files you need, we've provided a link here to the [participant_data folder](https://downgit.github.io/#/home?url=https://github.com/hc-sc/tdu-rph/tree/main/participant_data "Download the participant_data folder"). You can download just this folder and extract it to your working directory. 
...
For keeping ourselves organized, we also generally find it useful to create the following folders in your workspace: 1. scripts (to keep all your working scripts separated nicely) 2. output (where you would send all the files you created using write commands) 3. data (where you put your data inputs)
